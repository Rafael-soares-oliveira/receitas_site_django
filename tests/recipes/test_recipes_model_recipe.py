from test_recipes_model_base import RecipeTestModelBase, Recipe
from django.core.exceptions import ValidationError
from parameterized import parameterized


class RecipeRecipeModelTest(RecipeTestModelBase):
    def setUp(self) -> None:
    ...
    def test_recipe_preparation_step_is_html_is_false_default(self):
